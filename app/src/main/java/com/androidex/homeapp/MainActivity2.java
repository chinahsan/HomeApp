...
import com.androidex.homeapp.map.AMapUtil;
import com.androidex.homeapp.map.PoiOverlay;
import com.androidex.homeapp.map.ToastUtil;
...
public class MainActivity2 extends FragmentActivity implements
    ...
    public void searchButton() {
        ...
        if ("".equals(keyWord)) {
            ToastUtil.show(MainActivity2.this, "请输入搜索关键字");
            return;
        } else {
            doSearchQuery();
        }
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        ToastUtil.show(MainActivity2.this, infomation);
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        if (!AMapUtil.IsEmptyOrNullString(newText)) {
            ...
            Inputtips inputTips = new Inputtips(MainActivity2.this, inputquery);
